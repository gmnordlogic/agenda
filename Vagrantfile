...
#     config.vm.synced_folder "./", "/mnt/vagrant-agenda", type: 'nfs'
#     config.bindfs.bind_folder "/mnt/vagrant-agenda", "/vagrant", owner: "vagrant", group: "www-data", perms: "u=rwX:g=rwX:o=rD"
#  end

  #disable the default share
  config.vm.synced_folder ".", "/vagrant", disabled: true
  #required for provisioning the virtual machine
  config.vm.synced_folder ".vagrant-provision", "/vagrant/.vagrant-provision"
